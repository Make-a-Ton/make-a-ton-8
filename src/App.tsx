  ...
  return (
    <>
      ...
      <div className="app-container">
        ...
        {/* Bottom Section with FAQ and Contact */}
        <div className="bottom-section">
          ...
          <div className="bottom-content-container">
            ...
            <div className="connect-section-container">
              <p className="wanna-connect-text">
                wanna connect?
              </p>
...
function App() {
  return (
    <Routes>
      ...
      <Route path="/gallery" element={<ExternalRedirect to="https://www.playbook.com/s/makeaton/make-a-ton-8-0" />} />
      <Route path="/upsidedownfeedback" element={<ExternalRedirect to="https://tally.so/r/jabykR" />} />
      <Route path="/upsidedowngallery" element={<ExternalRedirect to="https://photos.app.goo.gl/ctgo3M3sZUH6hzDF8" />} />
      <Route path="/callforproduction" element={<ExternalRedirect to="https://tally.so/r/jaalg4" />} />
      <Route path="/insta" element={<ExternalRedirect to="https://www.instagram.com/makeaton.cusat" />} />
      <Route path="/linkedin" element={<ExternalRedirect to="https://www.linkedin.com/company/makeaton" />} />
      <Route path="/whatsapp" element={<ExternalRedirect to="https://www.whatsapp.com/channel/0029ValGCQM60eBjNF5wS10C" />} />
